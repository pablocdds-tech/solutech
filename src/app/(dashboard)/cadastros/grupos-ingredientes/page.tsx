...
export const metadata: Metadata = { title: "Grupos de Ingredientes" };

export default async function GruposIngredientesPage() {
  const config = getConfigByRouteSlug("grupos-ingredientes")!;
