...
-- ===================
INSERT INTO public.items (id, org_id, name, type, ingredient_group_id, default_unit_id, min_stock, max_stock, is_active, settings)
VALUES
  -- Carnes
  ('00000000-0000-0000-0003-000000000001', '00000000-0000-0000-0000-000000000001', 'Filé Mignon', 'ingredient', '00000000-0000-0000-0002-000000000001', '00000000-0000-0000-0001-000000000001', 5, 50, true, '{}'),
  ('00000000-0000-0000-0003-000000000002', '00000000-0000-0000-0000-000000000001', 'Picanha', 'ingredient', '00000000-0000-0000-0002-000000000001', '00000000-0000-0000-0001-000000000001', 5, 40, true, '{}'),
  ('00000000-0000-0000-0003-000000000003', '00000000-0000-0000-0000-000000000001', 'Peito de Frango', 'ingredient', '00000000-0000-0000-0002-000000000001', '00000000-0000-0000-0001-000000000001', 10, 80, true, '{}'),
  ('00000000-0000-0000-0003-000000000004', '00000000-0000-0000-0000-000000000001', 'Linguiça Calabresa', 'ingredient', '00000000-0000-0000-0002-000000000001', '00000000-0000-0000-0001-000000000001', 5, 30, true, '{}'),
  -- Laticínios
  ('00000000-0000-0000-0003-000000000005', '00000000-0000-0000-0000-000000000001', 'Queijo Mussarela', 'ingredient', '00000000-0000-0000-0002-000000000002', '00000000-0000-0000-0001-000000000001', 5, 40, true, '{}'),
  ('00000000-0000-0000-0003-000000000006', '00000000-0000-0000-0000-000000000001', 'Creme de Leite', 'ingredient', '00000000-0000-0000-0002-000000000002', '00000000-0000-0000-0001-000000000003', 5, 30, true, '{}'),
  ('00000000-0000-0000-0003-000000000007', '00000000-0000-0000-0000-000000000001', 'Manteiga', 'ingredient', '00000000-0000-0000-0002-000000000002', '00000000-0000-0000-0001-000000000001', 2, 15, true, '{}'),
  -- Hortifrúti
  ('00000000-0000-0000-0003-000000000008', '00000000-0000-0000-0000-000000000001', 'Tomate', 'ingredient', '00000000-0000-0000-0002-000000000003', '00000000-0000-0000-0001-000000000001', 5, 30, true, '{}'),
  ('00000000-0000-0000-0003-000000000009', '00000000-0000-0000-0000-000000000001', 'Cebola', 'ingredient', '00000000-0000-0000-0002-000000000003', '00000000-0000-0000-0001-000000000001', 5, 25, true, '{}'),
  ('00000000-0000-0000-0003-000000000010', '00000000-0000-0000-0000-000000000001', 'Alface', 'ingredient', '00000000-0000-0000-0002-000000000003', '00000000-0000-0000-0001-000000000005', 10, 50, true, '{}'),
  -- Secos
  ('00000000-0000-0000-0003-000000000011', '00000000-0000-0000-0000-000000000001', 'Arroz Branco 5kg', 'ingredient', '00000000-0000-0000-0002-000000000004', '00000000-0000-0000-0001-000000000007', 5, 30, true, '{}'),
  ('00000000-0000-0000-0003-000000000012', '00000000-0000-0000-0000-000000000001', 'Farinha de Trigo', 'ingredient', '00000000-0000-0000-0002-000000000004', '00000000-0000-0000-0001-000000000001', 5, 40, true, '{}'),
  -- Bebidas
  ('00000000-0000-0000-0003-000000000013', '00000000-0000-0000-0000-000000000001', 'Coca-Cola 2L', 'product', '00000000-0000-0000-0002-000000000005', '00000000-0000-0000-0001-000000000005', 20, 200, true, '{}'),
  ('00000000-0000-0000-0003-000000000014', '00000000-0000-0000-0000-000000000001', 'Água Mineral 500ml', 'product', '00000000-0000-0000-0002-000000000005', '00000000-0000-0000-0001-000000000005', 50, 500, true, '{}'),
  -- Embalagens
  ('00000000-0000-0000-0003-000000000015', '00000000-0000-0000-0000-000000000001', 'Embalagem Marmitex G', 'supply', '00000000-0000-0000-0002-000000000007', '00000000-0000-0000-0001-000000000005', 100, 1000, true, '{}'),
  ('00000000-0000-0000-0003-000000000016', '00000000-0000-0000-0000-000000000001', 'Guardanapo Pct 100un', 'supply', '00000000-0000-0000-0002-000000000007', '00000000-0000-0000-0001-000000000007', 10, 50, true, '{}'),
  -- Temperos
  ('00000000-0000-0000-0003-000000000017', '00000000-0000-0000-0000-000000000001', 'Azeite Extra Virgem 500ml', 'ingredient', '00000000-0000-0000-0002-000000000006', '00000000-0000-0000-0001-000000000005', 5, 20, true, '{}'),
  ('00000000-0000-0000-0003-000000000018', '00000000-0000-0000-0000-000000000001', 'Sal Refinado 1kg', 'ingredient', '00000000-0000-0000-0002-000000000006', '00000000-0000-0000-0001-000000000005', 5, 30, true, '{}'),
  -- Produto final
  ('00000000-0000-0000-0003-000000000019', '00000000-0000-0000-0000-000000000001', 'Marmitex Executivo', 'product', NULL, '00000000-0000-0000-0001-000000000005', NULL, NULL, true, '{}'),
  ('00000000-0000-0000-0003-000000000020', '00000000-0000-0000-0000-000000000001', 'Marmitex Simples', 'product', NULL, '00000000-0000-0000-0001-000000000005', NULL, NULL, true, '{}')
ON CONFLICT DO NOTHING;

-- ===================
-- FORNECEDORES
-- ===================
INSERT INTO public.suppliers (id, org_id, name, cnpj, phone, city, state, is_active)
VALUES
  ('00000000-0000-0000-0004-000000000001', '00000000-0000-0000-0000-000000000001', 'Frigorífico São José', '11.222.333/0001-01', '(85) 3333-1111', 'Fortaleza', 'CE', true),
  ('00000000-0000-0000-0004-000000000002', '00000000-0000-0000-0000-000000000001', 'Distribuidora Ceará Bebidas', '22.333.444/0001-02', '(85) 3333-2222', 'Maracanaú', 'CE', true),
  ('00000000-0000-0000-0004-000000000003', '00000000-0000-0000-0000-000000000001', 'Atacadão Hortifrúti', '33.444.555/0001-03', '(85) 3333-3333', 'Fortaleza', 'CE', true),
  ('00000000-0000-0000-0004-000000000004', '00000000-0000-0000-0000-000000000001', 'Laticínios Bom Gosto', '44.555.666/0001-04', '(85) 3333-4444', 'Caucaia', 'CE', true),
  ('00000000-0000-0000-0004-000000000005', '00000000-0000-0000-0000-000000000001', 'Embalagens Nordeste', '55.666.777/0001-05', '(85) 3333-5555', 'Fortaleza', 'CE', true),
  ('00000000-0000-0000-0004-000000000006', '00000000-0000-0000-0000-000000000001', 'Secos e Molhados Ltda', '66.777.888/0001-06', '(85) 3333-6666', 'Fortaleza', 'CE', true)
ON CONFLICT DO NOTHING;
